...
\conferenceinfo{ICMR 2014 SoMuS Workshop,}{Glasgow, Scotland}
...
\alignauthor Carlo Andrea Conte\\
    ...
    \email{\small{carloante@msn.com}}
\alignauthor Rapha\"el Troncy\\
	\affaddr{EURECOM}\\
	\affaddr{Biot, France}\\
	\email{\small{raphael.troncy@eurecom.fr}}	\\
\alignauthor Mor Naaman\\
    \affaddr{Cornell Tech and Mahaya, Inc.}\\
    \affaddr{New York, USA}\\
    \email{\small{mor.naaman@cornell.edu}}
}
