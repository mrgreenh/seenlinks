...
After introducing similar and related projects in Section \ref{sec:related-work}, we will discuss the general architecture of the system we implemented in Section \ref{sec:architecture}. This section will also describe the implementation of the two score processors we used for our tests. Sections \ref{sec:experiment} and \ref{sec:sources} will comment the data and storylines obtained with our experiments.
